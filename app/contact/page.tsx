            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 py-20 md:grid-cols-2 md:divide-x">
                <div className="py-6 md:py-0 md:px-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="flex items-center">
                            ...
                            <a href="https://www.trustpilot.com/review/rtmtransit.com" target="_blank" className="ml-3 text-gray-900 hover:underline truncate w-72 dark:text-gray-400" title="Review our company">
                ...
                <Form action={submitForm} className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    <label className="block">
                        ...
                        <input type="text" name="name" id="name" placeholder="George Washington" className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-emerald-600 bg-gray-100" />
                    </label>
                    <label className="block">
                        <span className="mb-1">Email address</span>
                        <input type="email" name="email" id="email" placeholder="george@example.com" className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-emerald-600 bg-gray-100" />
                    </label>
                    <label className="block">
