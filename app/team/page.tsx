...
import { teamList } from '@/config/team';
...
export default async function Page(){
    return (
        <section className="pb-6 bg-gray-100 text-gray-800">
            <PageTitle 
                title="Meet Our Team" 
                subtitle={`Driven by Experience, United by Purpose. Meet The People Behind the Wheel of Progress.`}
                bg="bg-white" 
            />
            <div className="container p-4 mx-auto space-y-16 sm:p-10">
                ...
                <div className="space-y-4">
                    ...
                    <p className="max-w-2xl text-gray-600">
                        At RTM Transit, we have assembled the best team to carry out our mission.
                    </p>
                </div>
                */}
