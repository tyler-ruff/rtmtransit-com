        ...
        <footer className="px-4 divide-y bg-gray-100 text-gray-800 border-t select-none">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start hover:opacity-75">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            {social.twitter && (
                                <a rel="noopener noreferrer" href={social.twitter} target="social" title="Twitter" className="flex items-center p-1 hover:opacity-75">
                            ...
                            {social.instagram && (
                                <a rel="noopener noreferrer" href={social.instagram} target="social" title="Instagram" className="flex items-center p-1 hover:opacity-75">
                            ...
                            {social.linkedin && (
                                <a rel="noopener noreferrer" href={social.linkedin} target="social" title="Linkedin" className="flex items-center p-1 hover:opacity-75">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-6 h-6 fill-current" viewBox="0 0 30 30">
