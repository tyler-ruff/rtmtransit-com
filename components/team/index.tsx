    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col items-center">
                ...
                {
                    props.contact?.email ? 
                        <p title="Email" className="text-sm text-gray-500 hover:text-gray-900">
                ...
                <div className="flex mt-2 space-x-2">
                    {
                        props.social?.twitter ? 
                            <a rel="noopener noreferrer" target="_blank" href={props.social?.twitter} title="Twitter" className="text-gray-600 hover:text-gray-900">
                    ...
                    }
                    {
                        props.social?.linkedin ? 
                            <a rel="noopener noreferrer" target="_blank" href={props.social?.linkedin} title="LinkedIn" className="text-gray-600 hover:text-gray-900">
                    ...
                    {
                        props.social?.github ?
                            <a rel="noopener noreferrer" target="_blank" href={props.social?.github} title="GitHub" className="text-gray-600 hover:text-gray-900">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
